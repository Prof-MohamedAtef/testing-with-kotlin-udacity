package com.example.android.architecture.blueprints.todoapp.instrumentation.taskdetail
...
class TaskDetailFragmentTest {
    ...
    fun activeTaskDetails_DisplayedInUi()= runBlockingTest{
        ...
        /*
        using espresso, check title and description are both shown and correct
         */
